=====================================================================
Haking On Scala（P-version）
=====================================================================

Abstract
~~~~~~~~

Spark官方网址为 `SPARK.DOC <http://spark.apache.org/>`_. 
...
.. warning::
   ...
   搭建环境时SPARK版本为spark-2.4.0-bin-without-hadoop-scala-2.12.tgz. 操作系统版本为ubuntu.16.04lts。
